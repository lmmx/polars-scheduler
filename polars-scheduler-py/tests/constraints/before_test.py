...
def test_before_constraint():
    ...
    print(f"Creatine time: {creatine_hour}h, Porridge time: {porridge_hour}h")

    # Creatine should be at least 1h before porridge
    time_diff = porridge_time - creatine_time
    print(f"Time difference: {time_diff // 60}h")
...
def test_before_constraint_with_category():
    ...
    assert is_before_lunch or is_before_dinner, (
        "Preworkout should be at least 1h before one food item"
    )
...
def test_before_constraint_multiple_daily():
    ...
    assert is_before_any_meal, (
        "Preworkout should be at least 1h before at least one meal instance"
    )
...
def test_earliest_strategy_with_before_constraint():
    ...
    assert supplement_time <= 480, (
        "With earliest strategy, supplement should be at 08:00 or earlier"
    )
    assert breakfast_time - supplement_time >= 60, (
